...
public class Dialogue {
    ...
    public void instructions(){
        System.out.println("    In this turn based game you will be fighting monsters that will do 1 of 5 attacks, after dropping them by 20% of their health, they will move from area to area and you will be required \n" +
                "o chase them to finish them off. After every 45% of their hp taken down, you will knock them on the ground, giving you a free 3 turns to hit them. After the 3rd turn, the monster will get \n" +
    ...
    public void hunt(){
        System.out.println("Good luck Hunter. You'll need it.");
    }
}
